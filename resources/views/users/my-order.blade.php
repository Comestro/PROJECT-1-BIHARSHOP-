            ...
            <div class="flex-1">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row flex-grow space-y-4 sm:space-y-0 sm:space-x-6 justify-between">
                            ...
                            <div class="flex flex-col text-red-500 text-sm space-y-2">
                                ...
                                <p class="text-gray-600 max-w-xs">The seller has cancelled your order because the courier
                                    service provider could not deliver the order to your location</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 p-4 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                        <!-- Product Image -->
                        <img src="https://rukminim2.flixcart.com/image/200/200/ks4yz680/air-conditioner-new/e/v/d/-original-imag5vnfykwufetq.jpeg?q=90"
                            alt="AC" class="w-24 h-24 object-cover rounded-lg mx-auto sm:mx-0">
                        <!-- Product Details -->
                        <div class="flex flex-col sm:flex-row flex-grow space-y-4 sm:space-y-0 sm:space-x-6 justify-between">
                            <!-- Product Info -->
                            <div class="flex-1">
                                <h2 class="text-xl font-semibold text-gray-800">Voltas 1.5 Ton AC</h2>
                                <p class="text-gray-600">Color: White</p>
                            </div>
                            ...
                            <!-- Cancellation Info -->
                            <div class="flex flex-col text-red-500 text-sm space-y-2">
                                <p class="font-medium">Cancelled on Feb 10</p>
                                <p class="text-gray-600 max-w-xs">The seller has cancelled your order due to supply
                                    chain issues</p>
                            </div>
                        </div>
                    </div>

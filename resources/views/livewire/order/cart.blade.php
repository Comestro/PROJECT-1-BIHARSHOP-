<div class="flex flex-col overflow-y-auto ">
    <div class="flex-1 overflow-y-auto">
        ...
        @foreach ($orders->orderItems as $item)
            <div
                class=" flex flex-col lg:flex-row items-center justify-between p-4 py-6 lg:p-6 rounded-lg bg-white border border-slate-200 mb-4 shadow-md">
                {{-- <!-- Delete Button -->
            <button wire:click="destroy({{ $item->id }})" class="absolute top-2 right-2 text-red-600 text-xs lg:text-sm flex items-center p-2">
                ...
                <!-- Quantity Control -->
                <div class="flex flex-col items-center justify-between mt-4 lg:mt-0 lg:ml-8 gap-4 w-full lg:w-auto">
                    ...
                    <div class="">
                        ...
                        <button wire:click="destroy({{ $item->id }})"
                            class="ml-2 right-2 text-red-600 text-xs lg:text-sm flex items-center mt-4">

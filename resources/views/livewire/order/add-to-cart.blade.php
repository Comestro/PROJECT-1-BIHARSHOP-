                ...
                <div class="inline-flex space-x-2">
                    @foreach ($colors as $color)
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="radio" wire:model="color_variant_id" name="color_variant_id" value="{{ $color->id }}" class="sr-only peer">
                    ...
                    <div class="flex gap-2">
                        @foreach ($sizes as $size)
                            <label class="cursor-pointer">
                                <input type="radio" wire:model="size_variant_id" name="size_variant_id" value="{{ $size->id }}" class="hidden peer" />

<div class="my-4 bg-white  px-5 py-2 ">
    <div class="flex justify-between items-center pb-2">
        <div class="flex items-center space-x-2">
            <span class="text-slate-100 bg-zinc-800 rounded-full w-6 h-6 flex justify-center items-center">4</span>
            <h3 class="text-md font-semibold">PAYMENT OPTIONS</h3>
        </div>
    </div>

    <div class="container my-5">
        <div class="form-check mb-3 flex items-center gap-2">
            <input class="w-4 h-4 text-slate-500 focus:ring-slate-500" type="radio" name="payment_method" id="upi"
                value="UPI" checked>
        ...
        <div class="flex gap-2 mt-6 justify-center">
            <div class="mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-10" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="gray" class="size-6 fill-green-600">

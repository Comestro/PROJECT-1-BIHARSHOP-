<div class="w-full mx-auto p-8 bg-white shadow-xl rounded-lg">
    ...
    <form wire:submit.prevent="update"  method="PUT" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="date" wire:model.live="date_of_birth"  name="date_of_birth"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="text" wire:model="mother_name"  name="mother_name"
                placeholder="Mother's Name"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
        </div>

        <textarea placeholder="Home Address" wire:model="home_address"  name="home_address"
            rows="2"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="number" wire:model="pincode"  name="pincode"
                placeholder="Pincode"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
            ...
            <input type="tel" wire:model="whatsapp" name="whatsapp" 
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            <input type="text" wire:model="nominee_name" name="nominee_name" 
                placeholder="Nominee Name"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>

            <input type="text" wire:model="nominee_relation" 
                name="nominee_relation" placeholder="Relation with Nominee"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            <input type="text" wire:model="bank_name" name="bank_name" 
                placeholder="Bank Name"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
            <input type="text" wire:model="branch_name" name="branch_name" 
                placeholder="Branch Name"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>

            <input type="number" wire:model="account_no" name="account_no" 
                placeholder="Account Number"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>

            <input type="text" wire:model="ifsc" name="ifsc" 
                placeholder="IFSC Code"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>

            <input type="text" wire:model="pancard" name="pancard" 
                placeholder="PAN Card Number"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">

            <input type="text" wire:model="aadhar_card" name="aadhar_card" 
        ...
        <div class="flex items-center justify-center w-full p-4">
            ...
            @elseif($existingImage)
                <div class="mt-2">
                    <img src="{{ asset('storage/image/membership/' . $existingImage) }}" alt="Current Image" class="w-32 h-32 object-cover border border-gray-300">
                </div>
            @endif

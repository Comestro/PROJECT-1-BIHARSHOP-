<div class="w-full mx-auto p-8 bg-white shadow-xl rounded-lg">
    ...
    <form wire:submit.prevent="store" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="text" wire:model="" name="" placeholder="Referred By"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                readonly>
        </div>
        <h3 class="text-xl font-semibold text-gray-700 mb-4">Applicant Details</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            <input type="text" wire:model="name" name="name" placeholder="First Name"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
            @error('name')
                <p class="text-xs text-red-500 font-semibold">{{ $message }}</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="tel" wire:model="mobile" name="mobile" placeholder="Mobile"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <input type="text" wire:model="nominee_relation" name="nominee_relation" placeholder="Relation with Nominee"
                class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
        </div>

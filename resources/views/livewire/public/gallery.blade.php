<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 px-5 gap-8">
    ...
    <div class="relative group overflow-hidden rounded-lg shadow-lg transition-all duration-500 hover:shadow-2xl transform hover:scale-105" onclick="this.classList.toggle('hovered')">
        <img class="w-full h-48 sm:h-64 object-cover object-top transition-transform duration-500 transform group-hover:scale-110 hovered:scale-110" src="{{ asset('storage/image/gallery/' . $item->image) }}" alt="Gallery Image {{ $key + 1 }}">

        ...
        <form class="flex items-center max-w-lg mx-auto w-full" wire:submit.prevent="searchProduct">
            ...
            <div class="relative flex w-full bg-gray-50 rounded-full border border-gray-300">
                <input type="search" wire:model.live="search" id="voice-search"
                    class="w-full bg-transparent text-gray-900 text-sm rounded-full pl-4 pr-10 py-2.5 focus:outline-none focus:ring-2 focus:ring-slate-500"
                    placeholder="Search Products..." required />
                <button type="submit"
                    class="absolute right-2 top-1/2 transform -translate-y-1/2  p-2 rounded-full text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">

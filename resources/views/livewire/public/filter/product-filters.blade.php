            ...
            <div class="bg-white w-full max-w-lg p-6 relative">
                ...
                <div class="overflow-y-auto max-h-screen">
                    ...
                    <div class="mb-3">
                                ...
                                @foreach ($moreCategories as $moreCategory)
                                    <li class="flex gap-2 items-center">
                                        <svg width="10" height="10" viewBox="0 0 16 27"
                                            xmlns="http://www.w3.org/2000/svg" class="IZmjtf">
                                            <path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z"
                                                fill="grey"></path>
                                        </svg>
                                        <a wire:navigate
                        ...
                        @if ($category->parent_category_id)
                            ...
                            <a wire:navigate
                                ...
                                class="flex  pl-4 gap-2 items-center mb-4 inline-block text-black font-semibold dark:text-black hover:underline text-sm">
                                <svg width="10" height="10" viewBox="0 0 16 27"
                                    xmlns="http://www.w3.org/2000/svg" class="rotate-[270deg] zyl78N">
                                    <path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z"
                                        fill="grey" class="S6zWo2"></path>
                                </svg>
                                {{ $category->parentCategory->name }}
                            </a>
                        @endif
                        ...
                        <ul class="space-y-2 border-l-2 border-gray-300 pl-4">
                            <li class="">
                                ...
                                @else
                                    <!-- No subcategories message -->
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">No subcategories available
                                    </p>
                                @endif
                            </li>
                        </ul>
                        ...
                        @foreach ($priceRanges as $key => $range)
                            <div class="mb-2">
                                <label class="flex items-center">
                                    ...
                                    @elseif($key == 'above_2500')
                                        Above Rs.2500
                                        ({{ \App\Models\Product::where('discount_price', '>=', 2501)->count() }})
                                    @else
                                        Rs.{{ $range[0] }}-{{ $range[1] }}
                                        ({{ \App\Models\Product::whereBetween('discount_price', $range)->count() }})
                                    @endif
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div>
                                <input type="radio" id="blue" name="color" value="blue"
                                    wire:model.live="selectedColor" class="hidden peer" />
                                <label for="blue"
                                    class="w-6 h-6 block rounded-full bg-blue-500 cursor-pointer peer-checked:ring-2 peer-checked:ring-offset-2 peer-checked:ring-blue-500"></label>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="space-y-2">
                            <button wire:click="$set('selectedSize', 's')"
                                class="px-4 py-2 border rounded">Small</button>
                            <button wire:click="$set('selectedSize', 'm')"
                                class="px-4 py-2 border rounded">Medium</button>
                            <button wire:click="$set('selectedSize', 'l')"
                                class="px-4 py-2 border rounded">Large</button>
                            <button wire:click="$set('selectedSize', 'xl')"
                                class="px-4 py-2 border rounded">X-Large</button>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        <button wire:click="clearFilter"
                            class="px-4 py-2 bg-red-500 text-white rounded">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="flex-1 mt-5 md:mt-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <!-- Clear Filter Button -->
                @if ($selectedPriceRanges || $selectedColor || $selectedSize)
                    <button wire:click="clearFilter" class="md:hidden flex text-white bg-slate-900 px-3 py-2 rounded">
                        Clear Filter
                    </button>
                @else
                    <!-- Toggle Filter SVG Icon -->
                    <button wire:click="toggleFilter" class="md:hidden flex px-3 py-2 rounded cursor-pointer">
                            ...
                            <a wire:navigate
                                ...
                                <div class="px-3 mt-2 pb-5">
                                    ...
                                    <div class="flex justify-between">
                                        <span
                                            class="text-xl md:text-2xl font-semibold text-gray-900 ">{{ $product->formattedDiscountPrice }}</span>
                                    </div>
                                </div>
                            </a>
                        </div>

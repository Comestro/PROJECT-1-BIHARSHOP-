<div class="flex items-center space-x-2">
    <div class="flex gap-1 bg-green-600 items-center justify-center text-xs  px-2 py-[3px] rounded-full">
    <span class="text-normal font-semibold  text-white rounded-full">{{ number_format($averageRating, 1) }} </span>

        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-current text-white"

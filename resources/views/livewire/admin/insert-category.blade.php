            ...
            <div class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea rows="6" placeholder="Type your message" class="w-full border-slate-200 rounded border border bg-transparent px-5 py-3 " wire:model="cat_description"></textarea>
                    </div>

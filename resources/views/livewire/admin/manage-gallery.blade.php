<div>
    <div class="flex  justify-between">
        <div>
            <h1 class="text-xl md:text-2xl font-bold mb-4">Manage Coupon</h1>
        </div>
        <div class="">
        ...
        <div class="bg-blue-500 text-white px-3 py-2 self-start hover:bg-blue-600 rounded-full shadow-lg flex items-center">
    ...
    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
        ...
        <tbody>
            ...
            <tr class="border-b">
                <td class="py-2 px-4 whitespace-nowrap">{{$coupon->code}}</td>
                <td class="py-2 px-4 whitespace-nowrap">{{$coupon->discount_type}}</td>
                <td class="py-2 px-4 whitespace-nowrap">{{$coupon->discount_value}}</td>
                <td class="py-2 px-4 whitespace-nowrap">{{$coupon->expiration_date}}</td>
                <td class="py-2 px-4">
                    <div class="inline-flex items-center">
                        <button
                            ...
                            <span
                                ...
                                {{ $coupon->status ? 'translate-x-5' : 'translate-x-0' }}"></span>
                        </button>
                    </div>
                </td>

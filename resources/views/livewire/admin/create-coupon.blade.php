<div>
    <form wire:submit.prevent="store" method="POST" class="bg-white p-4 sm:p-6 rounded-lg shadow-md relative">
        @csrf
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select id="discount_type" wire:model="discount_type" class="mt-1 block w-full border border-gray-300 rounded px-3 py-2">
            ...
            <div>
                ...
                <input type="number" id="discount_value" wire:model="discount_value" class="mt-1 block w-full border border-gray-300 rounded px-3 py-2" placeholder="Discount Value" step="0.01" />
            ...
            <div>
                ...
                <input type="date" id="expiration_date" wire:model="expiration_date" class="mt-1 block w-full border border-gray-300 rounded px-3 py-2" />

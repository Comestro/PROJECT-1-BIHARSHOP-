        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr class="bg-gray-100 border-b">
                    ...
                    <th class="py-2 px-4 text-left text-gray-600">Attribute Name</th>
                    <th class="py-2 px-4 text-left text-gray-600">Value</th>
            ...
            <tbody>
                ...
                <tr class="border-b capitalize">
                    ...
                    <td class="py-2 px-4">{{$attribute->attribute->name}}</td>
                    <td class="py-2 px-4">{{$attribute->value}}</td>
                    <td class="px-6 py-4 flex gap-2">
                        <button wire:click="openModal({{ $attribute->id }})" class="flex justify-between border-none ring-1 ring-gray-300 font-bold focus:ring-gray-400 focus:ring-2 bg-white text-blue-500 px-4 py-2 rounded-3xl  hover:bg-blue-500 hover:text-white">
                          ...
                          <button wire:click="confirmDelete({{ $attribute->id }})" class="flex justify-between bg-white text-red-900 px-4 font-bold py-2 rounded-3xl shadow hover:bg-red-500 hover:text-white transition duration-300 border-none ring-1 ring-gray-300 focus:ring-gray-400 focus:ring-2">

<div>
    <form wire:submit.prevent="update" method="POST" class="b bg-gray-100 p-6 rounded-lg shadow-md relative">
        @csrf
        ...
        <div class="mt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
                <div>
                    ...
                    <select id="variant_type_{{ $index }}" wire:model="variants.{{ $index }}.type" class="mt-1 block w-full border border-gray-300 rounded px-3 py-2">
        ...
        <div class="mt-6 flex justify-end">
            @if(!$showUpdateButton)
                <button type="button" wire:click="addVariant" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                    Add Variant
                </button>
            @endif

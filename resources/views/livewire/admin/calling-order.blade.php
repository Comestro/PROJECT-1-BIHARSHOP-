<div class="container mx-auto py-8">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-center mb-5">
        ...
        <div class="flex items-center gap-2">
            ...
            <select wire:model.live="filterStatus" class="px-3 border py-2 rounded-2xl border-none ring-1 ring-gray-300 focus:ring-gray-400 focus:ring-2">
            ...
            <select wire:model.live="filterMonth" class="px-3 border py-2 rounded-2xl border-none ring-1 ring-gray-300 focus:ring-gray-400 focus:ring-2">

<div class="mx-auto w-full p-4 md:p-6 2xl:p-10">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b ">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <button wire:click="openModal({{ $member->id }})" class="bg-blue-500 hover:bg-blue-800 text-white px-4 py-2 rounded-3xl flex items-center space-x-2">
                        ...
                        <button wire:click="confirmDelete({{ $member->id }})" class="bg-red-500 hover:bg-red-800 text-white px-4 py-2 rounded-3xl flex items-center space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-lg">
            <h3 class="text-lg font-semibold mb-4">Edit Membership</h3>
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-lg">
            ...
            <div class="flex justify-end gap-2">
                <button wire:click="deleteMembership" class="bg-red-500 hover:bg-red-800 text-white px-4 py-2 rounded">
                    Delete
                </button>

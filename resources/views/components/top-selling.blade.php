<h1 class="text-3xl font-black text-center mt-20 mb-8">Top Selling</h1>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 px-[5%]">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="p-8 rounded-t-lg" src="https://www.figma.com/design/VZaFDKHHHylJUbIJLGx1uz/E-commerce-Website-Template-(Freebie)-(Community)?node-id=22-412&t=N6XmVcKn6j1uEtug-4" alt="product image" />
        </a>
        <div class="px-5 pb-5">
            <a href="#">

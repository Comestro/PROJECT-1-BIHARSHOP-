<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    ...
    <div class="w-full gap-4 flex flex-wrap items-center justify-around  mx-auto px-[5%] py-4">
        <div class="flex gap-3">
            ...
            <a href="#" class="flex items-center  rtl:space-x-reverse">
                <span class="self-center text-2xl whitespace-nowrap font-black dark:text-white">BIHARSHOP</span>
            </a>
        </div>

        <div>
            <!-- icons for phone screen   -->
            <div class=" flex gap-2 md:hidden justify-end">
            ...
            <div class="flex flex-1 items-center gap-10 justify-around">
                <!-- links -->
                <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Shop</a>
                                    </li>
                        ...
                        <li>
                            <a href="#" class="block py-2 px-3 text-slate-500 rounded hover:bg-slate-slate-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-slate-500 rounded hover:bg-slate-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Pricing</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-slate-500 rounded hover:bg-slate-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="hidden  md:block">
                    ...
                    <form class="max-w-md mx-auto w-[550px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 " placeholder="Search for your products" required />
                            <button type="submit" class=" absolute end-2.5 bottom-2.5 focus:ring-4 focus:outline-none text-black focus:ring-black font-medium rounded-full text-sm px-4 py-2 dark:bg-white dark:hover:bg-gray-100 dark:focus:ring-gray-200">Search</button>
                        </div>
                    </form>

    ...
    <div class="container mx-auto px-[6%] py-2]">
        ...
        <div class="mt-8 border-t border-gray-700 pt-4 text-center text-sm">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-4">
                <img src="path/to/visa-icon.svg" alt="Visa" class="h-6">
                <img src="path/to/mastercard-icon.svg" alt="MasterCard" class="h-6">
                <img src="path/to/amex-icon.svg" alt="American Express" class="h-6">
                <img src="path/to/paypal-icon.svg" alt="PayPal" class="h-6">

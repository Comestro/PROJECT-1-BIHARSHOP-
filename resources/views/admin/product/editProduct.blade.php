...
<main>
    <div class="max-w-7xl mx-auto p-6 w-full">
        <h2 class="text-2xl font-bold mb-6">Edit Products</h2>
            ...
            <div class="flex flex-col w-1/2">
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        <span id="name-text-1">Clinic Plus</span>
                        <button onclick="toggleInput('1', 'name')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="name-input-section-1" class="hidden mt-2">
                        <input type="text" id="name-input-1" class="w-full px-3 py-2 border rounded-lg" value="Clinic Plus">
                        <button onclick="saveInput('1', 'name')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div> 
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'slug')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="slug-input-section-1" class="hidden mt-2">
                        <input type="text" id="slug-input-1" class="w-full px-3 py-2 border rounded-lg" value="clinic-plus">
                        <button onclick="saveInput('1', 'slug')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div> 
               ...
               <!-- Box for Product Description -->
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'description')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="description-input-section-1" class="hidden mt-2">
                        ...
                        <button onclick="saveInput('1', 'description')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'price')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="price-input-section-1" class="hidden mt-2">
                        ...
                        <button onclick="saveInput('1', 'price')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'discount_price')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="discount_price-input-section-1" class="hidden mt-2">
                        <input type="text" id="discount_price-input-1" class="w-full px-3 py-2 border rounded-lg" value="$19.99">
                        <button onclick="saveInput('1', 'discount_price')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
            ...
            <div class="flex flex-col w-1/2">
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'quantity')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="quantity-input-section-1" class="hidden mt-2">
                        ...
                        <button onclick="saveInput('1', 'quantity')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'sku')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="sku-input-section-1" class="hidden mt-2">
                        <input type="text" id="sku-input-1" class="w-full px-3 py-2 border rounded-lg" value="CLINIC-123">
                        <button onclick="saveInput('1', 'sku')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'brand')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="brand-input-section-1" class="hidden mt-2">
                        <input type="text" id="brand-input-1" class="w-full px-3 py-2 border rounded-lg" value="Clinic">
                        <button onclick="saveInput('1', 'brand')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'category_id')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="category_id-input-section-1" class="hidden mt-2">
                        <input type="text" id="category_id-input-1" class="w-full px-3 py-2 border rounded-lg" value="1">
                        <button onclick="saveInput('1', 'category_id')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'image')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="image-input-section-1" class="hidden mt-2">
                        <input type="file" id="image-input-1" class="w-full px-3 py-2 border rounded-lg">
                        <button onclick="saveImage('1')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>
                ...
                <div class="p-4 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="toggleInput('1', 'status')" class="bg-black text-white text-xs px-3 py-1 rounded-md">EDIT</button>
                    </div>
                    <div id="status-input-section-1" class="hidden mt-2">
                        ...
                        <button onclick="saveInput('1', 'status')" class="bg-black text-white text-xs px-3 py-1 rounded-md mt-2">SAVE</button>
                    </div>
                </div>

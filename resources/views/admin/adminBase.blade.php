    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <a href="index.html">
                    <img src="{{ asset('assets/assets_admin/images/logo/logo.svg') }}" alt="Logo" />
                </a>
                ...
                <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    href="javascript:void(0)" @click.prevent="selected = (selected === 'Categories' ? '':'Categories')"
                                    :class="{
                                        'bg-graydark dark:bg-meta-4': (selected === 'Categories') || (
                                            page === 'addCategory' || page === 'manageCategory')
                                    }">
                                    <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                        :class="{ 'rotate-180': (selected === 'Categories') }" width="20"
                                        height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z"
                                    ...
                                    <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                ...
                                                :class="page === 'addCategory' && '!text-white'">Add Category</a>
                                        </li>
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                href="{{url('admin/manage-category')}}"
                                                :class="page === 'manageCategory' && '!text-white'">Manage Categories</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- Dropdown Menu End -->
                            ...
                            <li>
                                <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    href="javascript:void(0)" @click.prevent="selected = (selected === 'Products' ? '':'Products')"
                                    :class="{
                                        'bg-graydark dark:bg-meta-4': (selected === 'Products') || (
                                            page === 'addProduct' || page === 'manageProduct')
                                    }">
                                    <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                        :class="{ 'rotate-180': (selected === 'Products') }" width="20"
                                        height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M4.41107 6.9107C4.73651 6.58527 5.26414 6.58527 5.58958 6.9107L10.0003 11.3214L14.4111 6.91071C14.7365 6.58527 15.2641 6.58527 15.5896 6.91071C15.915 7.23614 15.915 7.76378 15.5896 8.08922L10.5896 13.0892C10.2641 13.4147 9.73651 13.4147 9.41107 13.0892L4.41107 8.08922C4.08563 7.76378 4.08563 7.23614 4.41107 6.9107Z"
                                    ...
                                    <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                ...
                                                :class="page === 'addProduct' && '!text-white'">Add Product</a>
                                        </li>
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                href="{{url('admin/manage-product')}}"
                                                :class="page === 'manageProduct' && '!text-white'">Manage Products</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- Dropdown Menu End -->
                ...
                <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
                    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
                        ...
                        <a class="block flex-shrink-0 lg:hidden" href="index.html">
                            <img src="{{ asset('assets/assets_admin/images/logo/logo-icon.svg') }}" alt="Logo" />
                        </a>
                    </div>
                                    ...
                                    <ul class="flex h-auto flex-col overflow-y-auto">
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                ...
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('assets/assets_admin/images/user/user-02.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('assets/assets_admin/images/user/user-01.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('assets/assets_admin/images/user/user-03.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('assets/assets_admin/images/user/user-04.png') }}"
                                                        alt="User" />
                                                </div>

                    ...
                    <div class="container p-4 sm:p-6">
                        ...
                        @if ($order)
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4 sm:p-6 mx-auto mt-6 sm:mt-8 w-full">
                                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">Order:
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-b hover:bg-gray-200">
                                            ...
                                            <td class="py-2 px-2 sm:px-4">
                                                {{ $order->address ? $order->address->full_address : 'N/A' }}</td>
                                        </tr>
                                        <tr class="border-b hover:bg-gray-200">
                                        ...
                                        <tr class="border-b hover:bg-gray-200">
                                            ...
                                            <td class="py-2 px-2 sm:px-4">${{ number_format($order->shipping_charge, 2) }}
                                            </td>
                                        </tr>
                                        <tr class="border-b hover:bg-gray-200">
                                ...
                                <div class="mt-4 sm:mt-6 flex justify-end">
                                    <a href="{{ route('orders.index') }}"
                                        class="text-green-600 hover:text-green-800 underline">Back to Orders List</a>
                                </div>
                            </div>
                        @else
                                ...
                                <tbody>
                                    @foreach ($order->orderItems as $item)
                                        <tr>
                                            ...
                                            <td class="py-2 px-4 border-b text-center">
                                                @if ($item->colorVariant)
                                                    <div class="w-6 h-6 rounded-full"
                                                        style="background-color: {{ $item->colorVariant->variant_value }};">
                                                    </div>
                                                @else
                                                    N/A
                                                @endif                                                
                                            ...
                                            <td class="py-2 px-4 border-b text-center">
                                                {{ $item->sizeVariant->variant_value ?? 'NULL' }}</td>
                                            <td class="py-2 px-4 border-b text-center">{{ $item->quantity }}</td>
                                            <td class="py-2 px-4 border-b text-center">
                                                ₹{{ number_format($item->products->discount_price, 2) }}</td>
                                            <td class="py-2 px-4 border-b text-center">
                            ...
                            <table class="table-auto w-full text-left border-collapse">
                                <tbody>
                                    ...
                                    <tr class="border-b  hover:bg-gray-200">
                                        ...
                                        <td class="py-2 px-4">{{ $order->address ? $order->address->full_address : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr class="border-b  hover:bg-gray-200">
                        ...
                        <tbody>
                            @foreach ($order->orderItems as $item)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b text-center">
                                        @if ($item->colorVariant)
                                            <div class="w-6 h-6 rounded-full text-center"
                                                style="background-color: {{ $item->colorVariant->variant_value }};"></div>
                                        @else
                                            N/A
                                        @endif
                                    </td>

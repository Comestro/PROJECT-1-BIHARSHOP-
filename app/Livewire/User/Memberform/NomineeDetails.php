            ...
            <form wire:submit.prevent="save" method="post" class="mt-3">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="mb-3 flex-1 col-span-2">
                        <input type="submit" class="bg-green-600 rounded-lg float-end px-3 py-2 text-white hover:cursor-pointer disabled:cursor-not-allowed disabled:bg-green-500" value="Submit & Next Step" @if(!$isValidated) disabled @endif>
                    </div>
                </div>
            </form>
        </div>
